...
$(function(){
  ...
  var barChartData = {
    ...
    datasets: [
      {
        label               : 'Borrow',
        fillColor           : 'rgba(110, 114, 111, 1)',
        strokeColor         : 'rgba(110, 114, 122, 1)',
        pointColor          : 'rgba(110, 114, 122, 1)',
        pointStrokeColor    : '#c1c7d1',
        pointHighlightFill  : ' #ebfef0',
        pointHighlightStroke: 'rgba(120,220,120,1)',
        data                : <?php echo $borrow; ?>
      },
      {
        label               : 'Return',
        fillColor           : 'rgba(30,101,108,0.9)',
        strokeColor         : 'rgba(30,101,108,0.8)',
        pointColor          : '#3b8bba',
        pointStrokeColor    : 'rgba(30,101,108,1)',
        pointHighlightFill  : ' #ebeef0',
        pointHighlightStroke: 'rgba(30,101,108,1)',
        data                : <?php echo $return; ?>
      }
    ]
  }
  barChartData.datasets[1].fillColor   = '#ff00ff'
  barChartData.datasets[1].strokeColor = '#e74c3'
  barChartData.datasets[1].pointColor  = '#8e44ad'
  var barChartOptions                  = {
